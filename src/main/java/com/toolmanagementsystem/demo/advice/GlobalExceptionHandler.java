...
import com.toolmanagementsystem.demo.exceptions.*;
import lombok.Data;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RuntimeConflictExceptionn.class)
    public ResponseEntity<ApiResponse<?>> handleRuntimeConflictException(RuntimeConflictExceptionn exception) {
        ApiError apiError = ApiError.builder()
...
//        exception.printStackTrace();
    ...
    public ResponseEntity<ApiResponse<?>> handleDataIntegrityViolation(DataIntegrityViolationException ex) {
        log.error("Caught duplicate key exception: {}", ex.getMessage());
        ApiError apiError = ApiError.builder()
                .status(HttpStatus.INTERNAL_SERVER_ERROR)
